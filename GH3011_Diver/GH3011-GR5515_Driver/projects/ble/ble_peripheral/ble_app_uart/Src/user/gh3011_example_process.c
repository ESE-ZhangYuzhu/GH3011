...
extern const uint16_t hb_reg_config_array_len;


 const ST_REGISTER *gh30x_reg_config_ptr = hb_reg_config_array;
...
int gh30x_module_init(void)
{
    ...
    init_err_flag = HBD_CommunicationInterfaceConfirm();
    ...
    gh30x_reg_config_len = hb_reg_config_array_len;
...
void gh30x_int_msg_handler(void)
{
    ...
    gh30x_adt_working_flag = HBD_IsAdtWearDetectHasStarted();
	  ...
	  //EXAMPLE_DEBUG_LOG_L1("GPIO interrupt happen!\r\n");
